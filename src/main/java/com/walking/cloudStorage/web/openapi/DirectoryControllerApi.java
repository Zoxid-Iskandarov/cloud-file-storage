...
public interface DirectoryControllerApi {
    ...
    List<ResourceResponse> getDirectoryContent(@RequestParam(required = false, defaultValue = "") String path,
    ...
    ResourceResponse createDirectory(@RequestParam String path, @AuthenticationPrincipal UserPrincipal userPrincipal);
}
